# ClearUI modifications: named groups, bounded transfers, C5 receive-only channels.
...
DRIVER_VERSION = "Fusion 5.9.0 ClearUI C5/C6: named groups, receive-only, C6 meters"
...
WELCOME_LIST = ["Message line 1, Voltage, Sound (ALL)", "Make 2 short sounds (SOUND)", "User message line 1 and line 2 (MESSAGE)", "Battery voltage (VOLTAGE)", "ClearUI logo (C5)", "NONE"]
...
class UVK5RadioEgzumer(chirp_common.CloneModeRadio):
    ...
    VENDOR = "Quansheng"
    MODEL = "UV-K1 & UV-K5 V3 (Fusion ClearUI)"
    _memsize = MEM_SIZE
    BAUD_RATE = 38400
...
#            top.append(dtmfc)
    ...
    # basic.append(listname_setting)
        ...
        SetMetSetting = RadioSetting("set_met", "Meter style (C6: Spine / Ribbon)", val)
        SetMetSetting.set_doc('C6: Spine uses a vertical meter; Ribbon uses a horizontal strip. C5 retains its original meter.')
        # Set_gui f4hwn
        ...
        bat_txt_setting.set_doc('C8: Icon, Voltage, Percentage, or Icon + percentage. Earlier firmware may not display these choices correctly.')
